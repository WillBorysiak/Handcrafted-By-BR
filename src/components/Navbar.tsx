...
const navigation = [
	{ name: 'Home', pageLink: '', current: true },
	{ name: 'About', pageLink: 'about', current: false },
	{ name: 'Products', pageLink: 'products', current: false },
	{ name: 'Contact', pageLink: 'contact', current: false },
];
